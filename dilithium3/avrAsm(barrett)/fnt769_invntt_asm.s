...
/*!
 * @details     int32_t fnt769_invntt_asm (int32_t a[256]);
 * @brief       FNT
 ...
 */
            EXTERN  FNT_Q2_reverse
            NAME    fnt769_invntt_asm      ;   module name
            PUBLIC  fnt769_invntt_asm      ;   make the main label vissible outside this module
...
initialize:
    ...
    ldi     r30,    low (FNT_Q2_reverse)
    ldi     r31,    high(FNT_Q2_reverse)
...
in0:   
    mc_fnt_gs_hi    a0, a1, b0, b1, mont0, mont1
    mc_769_montmul  b0, b1, z0, z1, lo0, lo1, hi0, hi1, mont0, mont1, mont2, mont3, c_tmp, cst_q, zero
    mc_fnt_gs_lo    a0, a1, hi0, hi1, mont0
    dec     i_cnt
    brne    in0    
...
mont:
    ...
    mc_muls16x16_32 z0, z1, b0, b1, lo0, lo1, hi0, hi1, zero
    mc_769_montmul  z0, z1, b0, b1, lo0, lo1, hi0, hi1, mont0, mont1, mont2, mont3, c_tmp, cst_q, zero        
